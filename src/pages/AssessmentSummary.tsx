    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            {aiInsights && aiInsights.insights.length > 0 && (
              <Card className="shadow-xl bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
                <CardHeader>
                  <CardTitle className="text-2xl text-gray-900 mb-2">What We See In You</CardTitle>
                  <p className="text-gray-600">Our AI analysis has identified these key insights about your situation</p>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
          ...
          {/* Right Column - Chat with AI Coach */}
          <div className="flex flex-col">
            <Card className="shadow-xl border-none bg-gradient-to-br from-purple-100 via-pink-100 to-yellow-100 overflow-hidden flex-1">
              <CardContent className="pt-8 pb-8 text-center space-y-6 h-full flex flex-col justify-center">
