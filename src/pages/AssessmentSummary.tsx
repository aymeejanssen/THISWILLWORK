...
const AssessmentSummary = () => {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-6">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-4xl font-bold wellness-text-gradient">Choose Your AI Coaching Plan</h1>
  ...
  return <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {aiInsights && aiInsights.insights.length > 0 && (
          <div className="space-y-6">
            <Card className="shadow-xl bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
              <CardHeader>
                <CardTitle className="text-3xl wellness-text-gradient mb-2 text-center">Summarizing your answers</CardTitle>
        ...
        <div className="space-y-6">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold wellness-text-gradient">Choose Your AI Coaching Plan</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Start your personalized {primaryConcern} sessions with your AI wellness coach
            </p>
          </div>
