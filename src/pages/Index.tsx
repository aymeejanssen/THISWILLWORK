...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-wellness-purple via-wellness-teal to-wellness-yellow">
      {/* Hero Section */}
      <div className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 animate-fade-in">
            Welcome to{" "}
            <span className="bg-gradient-to-r from-yellow-200 to-purple-200 bg-clip-text text-transparent">
              MindEase
            </span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="group bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-br from-wellness-teal to-wellness-yellow rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="group bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-br from-wellness-purple to-wellness-yellow rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
