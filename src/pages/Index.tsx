    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="text-center max-w-4xl mx-auto">
          {/* Floating Badge */}
          <div className="inline-flex items-center gap-2 bg-black/5 backdrop-blur-sm rounded-full px-6 py-3 mb-12 border border-black/10">
            <Sparkles className="h-4 w-4 text-gray-700" />
            <span className="text-gray-700 text-sm font-medium">AI-Powered Mental Wellness</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-2xl mx-auto mb-32">
            <div className="text-center">
              ...
              <div className="text-gray-500 font-medium">AI Support</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-gray-900 mb-2">50+</div>
              <div className="text-gray-500 font-medium">Languages</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-gray-900 mb-2">100%</div>
              <div className="text-gray-500 font-medium">Private</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-32">
          <div className="group bg-white/60 backdrop-blur-sm rounded-3xl p-10 border border-gray-200/50 hover:border-gray-300/50 transition-all duration-300 hover:bg-white/80">
            <div className="w-12 h-12 bg-gray-100 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-gray-200 transition-colors">
        ...
        {/* Trust Indicators */}
        <div className="text-center">
          <p className="text-gray-500 mb-8 font-light">Trusted by people from over 50 countries</p>
